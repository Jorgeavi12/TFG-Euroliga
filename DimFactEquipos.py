...
def dividir_dim_fact_puro():
    ...
    if not col_id:
        print("Error: No se encuentra la columna 'ID Equipo' en el archivo.")
        return

    # 1. CREACIÓN DE LA TABLA DIM 
    print("Generando Tabla Dim_Equipos...")
    ...
    # Añadimos tres columans vacías para rellenar a mano luego
    df_dim['Ciudad'] = ""
    df_dim['Pais'] = ""
    df_dim['Logo'] = ""
    ...
    print("Generando Tabla Fact_Estadisticas con ABSOLUTAMENTE TODO el resto de columnas...")
    
    # En la Fact van TODAS las demás columnas (incluidos Temporada, Fase, Entrenador, W, L y métricas)
