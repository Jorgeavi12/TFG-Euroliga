...
def calcular_factores_oliver(df):
    ...
    # Pre-cálculo de posesiones para ambos (necesario para el ritmo y DRTG)
...
def organizar_columnas(df):
    ...
    columnas_ordenadas = [
        ...
        'Equipo Local', 'ID Equipo Local',     # 👈 ID Local al lado de Equipo Local
        'Equipo Visitante', 'ID Equipo Visitante' # 👈 ID Visitante al lado de Equipo Visitante
    ]
...
print("\n🚀 ¡Listo! Los 4 factores ocupan las últimas columnas, y los IDs están emparejados con sus equipos.")