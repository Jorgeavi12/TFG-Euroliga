...
def generar_fact_historica():
    ...
    if not os.path.exists(ruta_historico_origen):
        print(f"No se encontró el archivo histórico")
        return
    ...
    print("Generando Tabla Fact_Historico_Equipos...")
    
    # Seleccionamos TODAS las columnas menos 'Equipo'
    # Mantenemos 'ID_Equipo' al principio para que sirva de conector con la DIM
    ...
    print(f"Total de equipos: {len(df_fact_hist)}")
