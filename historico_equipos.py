...
def generar_master_equipos():
    ...
    for archivo in archivos:
        ...
        print(f"⚙️ Procesando temporada {anio}...")
        ...
        try:
            ...
            for _, fila in df.iterrows():
                ...
                # Buscamos 'ID Equipo' (con espacio) que es como lo tienes. 
    ...
    if not acumulado: 
        print("⚠ No se acumularon datos. Revisa que las cabeceras coincidan exactamente.")
        return
    ...
    print(f"✅ Master Equipos Unificado con éxito. Total de IDs únicos: {len(df_final)}")
