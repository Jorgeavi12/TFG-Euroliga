...
# Se mantienen tus columnas exactas y añadimos los IDs al final para no romper tu formato
all_columns = [
...
path = r".\Datos\\"
archivo_csv = path + 'estadisticas_partidos_E2024.csv'

try:
    df = pd.read_csv(archivo_csv)
    # Reasegurar que el DF cargado tenga las nuevas columnas si no existían
...
urls_24 = [f'https://www.euroleaguebasketball.net/en/euroleague/game-center/2024-25/a/E2024/{i}/' for i in range(1, 351)]
        ...
        try:
            ...
            if script_tag:
                ...
                totals = {
                    ...
                    'Competición': 'EL',
                    'Enlace': url,
                    'ID Equipo Local': id_equipo_local,       # 👈 Asignación de ID
                    'ID Equipo Visitante': id_equipo_visitante  # 👈 Asignación de ID
                }
